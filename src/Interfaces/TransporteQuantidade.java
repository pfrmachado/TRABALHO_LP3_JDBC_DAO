...
public class TransporteQuantidade extends javax.swing.JFrame {
    ...
    private void btnTransportarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTransportarActionPerformed
        try {
            ...
            {
                Estoque e = estoqueDAO.buscaByProdutoByFilial(produtoSelecionado, (String)cbbListaFiliais.getSelectedItem());
                if(e != null)
                {
                    e.setQuantidade(intNovaQuantidade + e.getQuantidade());
                    estoqueDAO.atualizaEstoque(e, e.getFilial(), e.getProduto());
                    //DESCONTA DO PRODUTO DA PRIMEIRA FILIAL
                    e = estoqueDAO.buscaByProdutoByFilial(produtoSelecionado, filialSelecionada);
                    e.setQuantidade(e.getQuantidade() - intNovaQuantidade);
                    estoqueDAO.atualizaEstoque(e, filialSelecionada, produtoSelecionado);
                ...
                else
                {
                    ...
                    e.setProduto(produtoSelecionado);
                    e.setQuantidade(intNovaQuantidade);
                    estoqueDAO.criaEstoque(e);
                    //DESCONTA DO PRODUTO DA PRIMEIRA FILIAL
                    e = estoqueDAO.buscaByProdutoByFilial(produtoSelecionado, filialSelecionada);
                    e.setQuantidade(e.getQuantidade() - intNovaQuantidade);
                    estoqueDAO.atualizaEstoque(e, filialSelecionada, produtoSelecionado);
    ...
    {
        txtProdutoSelecionado1.setText(produtoSelecionado);
        txtFilialSelecionada1.setText(filialSelecionada);
    }
    ...
    public void preencheComboBoxFiliais()
    {
        ...
        try {
            ...
            for (Estoque e : lista) {
                if(!e.getFilial().equals(filialSelecionada))
                    cbbListaFiliais.addItem(e.getFilial());
            }
        } catch (Exception ex) {
